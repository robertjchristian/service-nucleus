 ...
 * Compiled At: 02/23/2013 00:23:26
 ***********************************************/
...
//set event binding on the grid so we can select using the up/down keys
    ...
    ng.rowTemplate = function () {
        return '<div ng-style="{\'cursor\': row.cursor, \'z-index\': col.zIndex() }" ng-repeat="col in renderedColumns" ng-class="col.colIndex()" class="ngCell {{col.cellClass}}" ng-cell></div>';
    };
    ...
    ng.cellTemplate = function () {
        return '<div class="ngCellText" ng-class="col.colIndex()"><span ng-cell-text>{{COL_FIELD CUSTOM_FILTERS}}</span></div>';
    };
    ...
    ng.editableCellTemplate = function () {
        return '<input ng-cell-input ng-class="\'colt\' + col.index" ng-input="COL_FIELD" />';
    };
    ...
    ng.headerRowTemplate = function () {
        return '<div ng-style="{\'z-index\': col.zIndex(), height: col.headerRowHeight}" ng-repeat="col in renderedColumns" ng-class="col.colIndex()" class="ngHeaderCell" ng-header-cell></div>';
    };
